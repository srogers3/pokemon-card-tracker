...
export function StoreDetailPanel({
  ...
  return (
    <div className={cn(
      "absolute bottom-0 left-0 right-0 z-10 flex flex-col bg-card rounded-t-2xl shadow-lg border-t border-border/50 transition-[max-height] duration-300 ease-in-out",
